...
import MSAP1gen.create_config as cg
from MSAP1gen.common import PSLS_DIR, temp_chdir, read_yaml
from MSAP1gen.format import format_MSAP1_in
...
def get_parser():
    ...
    parser.add_argument('--keep-psls-hdf5', action='store_const', const=True, default=False,
                        help="Keep the hdf5 file generated by psls if --format is set, otherwise do nothing.")
    return parser
